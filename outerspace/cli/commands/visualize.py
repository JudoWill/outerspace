...
class VisualizeCommand(BaseCommand):
    ...
    def _init_parser(self, subparser: ArgumentParser) -> None:
        ...
        parser.add_argument(
            "input_dir", help="Input directory containing CSV files with barcode counts"
        )
        parser.add_argument(
            "output_dir", help="Output directory for visualization plots"
        )
        ...
        parser.add_argument(
            "--title-prefix", help="Prefix for plot titles (default: filename)"
        )
        parser.add_argument(
            "--xlabel", help="X-axis label (default: Number of Unique Barcodes)"
        )
        parser.add_argument("--ylabel", help="Y-axis label (default: Count)")
        parser.add_argument(
