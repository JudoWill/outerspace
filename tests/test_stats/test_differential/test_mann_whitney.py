...
def test_mann_whitney_differential_abundance():
    ...
    results = MannWhitneyDifferentialAbundance.calculate_differential_abundance(group1_df, group2_df)
...
def test_mann_whitney_differential_abundance_zero_counts():
    ...
    results = MannWhitneyDifferentialAbundance.calculate_differential_abundance(zero_df, zero_df)
...
def test_mann_whitney_differential_abundance_with_allowed_list(partial_umi):
    ...
    result = MannWhitneyDifferentialAbundance([partial_umi, partial_umi], ['group1', 'group2'], allowed_list=allowed_list).run()
