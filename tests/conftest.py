...
def temp_workspace():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        data_files = [
            ...
            (
                "tests/data/2-G1L9-M1_S9_L001_R1_001.fastq.gz",
                "reads/2-G1L9-M1_S9_L001_R1_001.fastq.gz",
            ),
            (
                "tests/data/2-G1L9-M1_S9_L001_R2_001.fastq.gz",
                "reads/2-G1L9-M1_S9_L001_R2_001.fastq.gz",
            ),
            (
                "tests/data/2-G1L9-M2_S12_L001_R1_001.fastq.gz",
                "reads/2-G1L9-M2_S12_L001_R1_001.fastq.gz",
            ),
            (
                "tests/data/2-G1L9-M2_S12_L001_R2_001.fastq.gz",
        ...
        config_files = [
            (
                "tests/test_cli/pipeline_data/samplesheet_config.yaml",
                "samplesheet_config.yaml",
            ),
            ("tests/test_cli/pipeline_data/samplesheet.csv", "samplesheet.csv"),
            (
                "tests/test_cli/pipeline_data/directory_config.yaml",
        ...
        for src, dst in config_files:
            ...
            if os.path.exists(src_path):
                ...
                raise FileNotFoundError(
                    f"Could not find config file: {src_path} for testing"
                )
